...
import compute_qoe
import qoe_cdf
from configs import raw_root,clean_root,qoe_root,pdf_root,exp_id
import os.path
...
if __name__=="__main__":
    ...
    for lid in lid_list:
        ...
        if file_extension(raw_path) == '.txt':
            prep_data.prep_txt(raw_path,clean_path,lid,True)
        else:
            prep_data.prep_raw(raw_path, clean_path,lid,True)
